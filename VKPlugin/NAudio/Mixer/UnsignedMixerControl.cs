...
namespace NAudio.Mixer
{
    ...
    public class UnsignedMixerControl : MixerControl
    {
        ...
        internal UnsignedMixerControl(MixerInterop.MIXERCONTROL mixerControl, IntPtr mixerHandle,
        ...
        protected override void GetDetails(IntPtr pDetails)
        {
            ...
            for (int channel = 0; channel < nChannels; channel++)
            {
                unsignedDetails[channel] =
                    (MixerInterop.MIXERCONTROLDETAILS_UNSIGNED)
                        Marshal.PtrToStructure(mixerControlDetails.paDetails,
