    ...
    public class AudioClient : IDisposable
    {
        ...
        public long DefaultDevicePeriod
        {
            get
            {
                ...
                Marshal.ThrowExceptionForHR(audioClientInterface.GetDevicePeriod(out defaultDevicePeriod,
        ...
        public AudioRenderClient AudioRenderClient
        {
            get
            {
                if (audioRenderClient == null)
                {
                    ...
                    Marshal.ThrowExceptionForHR(audioClientInterface.GetService(ref audioRenderClientGuid,
        ...
        public AudioCaptureClient AudioCaptureClient
        {
            get
            {
                if (audioCaptureClient == null)
                {
                    ...
                    Marshal.ThrowExceptionForHR(audioClientInterface.GetService(ref audioCaptureClientGuid,
